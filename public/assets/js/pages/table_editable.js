$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[6].innerHTML = '<div class="text-right"><a class="edit btn btn-sm btn-success" href="">Сохранить</a> <a class="delete btn btn-sm btn-danger" href=""><i class="icons-office-52"></i></a></div>';
        }
